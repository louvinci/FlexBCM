...
class ImageNet_For_Search(Dataset):
    def __init__(self, root, transforms_=None, num_class=100,is_random=False):
...
def prepare_train_data_for_search(dataset='imagenet', datadir='/home/lwq/dataset', num_class=100,is_random=False):
...
def prepare_test_data_for_search(dataset='imagenet', datadir='/home/lwq/dataset', num_class=100, is_random=False):
    if 'imagenet' in dataset:
        train_dataset = ImageNet_For_Search(
            datadir,
            transforms.Compose([
...
def prepare_train_data_autoaugment(dataset='imagenet', datadir='/home/lwq/dataset'):
    if 'imagenet' in dataset:
...
def prepare_train_data(dataset='imagenet', datadir='/home/lwq/dataset'):
    if 'imagenet' in dataset:
        train_dataset = torchvision.datasets.ImageFolder(
            datadir,
            transforms.Compose([
...
def prepare_test_data(dataset='imagenet', datadir='/home/lwq/dataset'):
...
if __name__=="__main__":
    ...
    dataset_train = prepare_train_data_for_search('imagenet-100',
                                          datadir=dir+'/validation', num_class=100,is_random=True)
